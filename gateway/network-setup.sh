...
clear
echo -e "\e[94m[3/7] Start DNS (named)..\e[0m"
./root-bind/bind-setup.sh
sleep 2.0

# Setup Firewall.
clear
echo -e "\e[94m[4/7] Setup NAT (iptables)..\e[0m"
./nat/tables-setup.sh
sleep 2.0

# Fix our own DNS-server reference.
clear
echo -e "\e[94m[5/7] Set default DNS-server to ourself..\e[0m"
echo "nameserver 10.0.0.1" | sudo tee /etc/resolv.conf
echo -e "\e[32m  [OK] Done.\e[0m"
sleep 2.0

clear
echo -e "\e[94m[6/7] Start TFTP..\e[0m"
./dhcp/tftp-setup.sh
sleep 2.0

clear
echo -e "\e[32m[6/7] Done. Status report:\e[0m"
